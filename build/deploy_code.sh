...
sfdx force:mdapi:deploy -u DevHub -d deploy_code/ -w 33  -w 33 --verbose --loglevel fatal -r DemoLWCControllerTest,SampleControllerTest --testlevel RunSpecifiedTests > /tmp/artifacts/deployResult.txt
