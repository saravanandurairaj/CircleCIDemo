...
sfdx force:mdapi:deploy -u DevHub -d deploy_code/ --testlevel RunSpecifiedTests -r DemoLWCControllerTest,SampleControllerTest -w 33 --verbose --loglevel fatal -f /tmp/artifacts