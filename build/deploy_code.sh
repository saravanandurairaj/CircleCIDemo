...
sfdx force:mdapi:deploy -u DevHub -d deploy_code/ -w 1000  --verbose --loglevel DEBUG -r DemoLWCControllerTest,SampleControllerTest --testlevel RunSpecifiedTests > /tmp/artifacts/deployResult.txt
